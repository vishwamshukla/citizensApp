...
import com.example.citizensapp.Activities.MainActivity;
import com.example.citizensapp.BuildConfig;
import com.example.citizensapp.MyLocation;
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                if (tensorFlowInferenceInterface == null) {
                    tensorFlowInferenceInterface = ApplicationClass.getInstance().getTensorFlowInferenceInterface();
                }
