...
public class ElectedRepresentativesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elected_representatives);
        ...
        mUsersDatabaseReference= FirebaseDatabase.getInstance().getReference().child("Users").child("Elected");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Users , CivilAgenciesActivity.UserViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Users, CivilAgenciesActivity.UserViewHolder>(
                Users.class,
                R.layout.recycle_list_single_user,
                CivilAgenciesActivity.UserViewHolder.class,
                mUsersDatabaseReference
        ) {
            @Override
            protected void populateViewHolder(CivilAgenciesActivity.UserViewHolder viewHolder, Users users, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent profileIntent=new Intent(ElectedRepresentativesActivity.this,ProfileActivity.class);
